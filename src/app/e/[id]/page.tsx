...
const EntryPage = async ({ params }: EntryProps) => {
    ...
    return (
        <>
            <Head>
                <title>{entry.entry} - Words of Death</title>
                <meta name="description" content={`Eintrag von ${user?.username}: ${entry.entry}`} />
                <meta name="author" content={user?.username || "Unknown"} />
                <meta property="og:title" content={entry.entry} />
                <meta property="og:description" content={`Eintrag von ${user?.username}: ${entry.entry}`} />
