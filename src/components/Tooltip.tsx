...
const Tooltip: React.FC<TooltipProps> = ({
   ...
   return (
      ...
      >
         <div
            ref={tooltipRef}
            className={`absolute z-10 px-2 py-1 bg-zinc-700 border border-zinc-600 text-white rounded-md whitespace-nowrap transition-opacity duration-300 ease-in-out ${fontSize} 
