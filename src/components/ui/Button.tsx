...
export const Button: React.FC<ButtonProps> = ({
    ...
    const baseStyles =
        "inline-flex h-10 items-center justify-center font-medium transition-all duration-200 rounded-lg disabled:opacity-50";
        const variants = {
            primary:
                "bg-neutral-600 text-neutral-100 hover:bg-neutral-700 active:bg-neutral-800",
            secondary:
                "bg-neutral-700 text-neutral-100 hover:bg-neutral-800 active:bg-neutral-900",
            outline:
                "border-2 border-neutral-400 text-neutral-100 hover:bg-neutral-700 active:bg-neutral-800",
            destructive:
                "bg-red-500 text-neutral-100 hover:bg-red-600 active:bg-red-700",
        };
