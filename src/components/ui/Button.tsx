...
export const Button: React.FC<ButtonProps> = ({
    ...
    const baseStyles =
        "inline-flex items-center justify-center font-medium transition-all duration-200 rounded-lg focus:ring-2 ring-offset-2 ring-offset-neutral-800/90 disabled:opacity-50";
    ...
    const variants = {
        ...
        destructive:
            "bg-red-500 text-neutral-100 hover:bg-red-600 focus:ring-red-500 active:bg-red-800",
    };
