...
export const Tooltip: React.FC<TooltipProps> = ({
   ...
   return (
      ...
      >
         <div
            ref={tooltipRef}
            className={`absolute z-10 px-2 py-1 bg-neutral-700 border border-neutral-600 text-neutral-100 rounded-md whitespace-nowrap transition-opacity duration-300 ease-in-out ${fontSize} 
